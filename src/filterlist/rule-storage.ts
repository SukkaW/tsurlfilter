...
export class RuleStorage {
    ...
    constructor(lists: IRuleList[]) {
        ...
        // const scanner = this.createRuleStorageScanner(ScannerType.NetworkRules);
        // while (scanner.scan()) {
        //     const indexedRule = scanner.getRule();
        //     if (indexedRule) {
        //         const [listId, ruleIdx] = RuleStorageScanner.storageIdxToRuleListIdx(indexedRule.index);
        //         this.saveToCache(listId, ruleIdx, indexedRule.rule);
        //     }
        // }
    }
    ...
    saveToCache(listId: number, ruleIdx: number, rule: IRule): void {
    ...
    getFromCache(listId: number, ruleIdx: number): IRule | undefined {
