...
class Storage {
    ...
    get = <T>(key: string): Promise<T | undefined> => new Promise((resolve, reject) => {
    ...
    set = (key: string, value: any): Promise<void> => new Promise((resolve, reject) => {
    ...
    remove = (key: string): Promise<void> => new Promise((resolve, reject) => {
